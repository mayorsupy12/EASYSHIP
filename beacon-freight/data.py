...
CARRIERS = [
    {'name':'Maersk Line','mode':'Ocean','rating':4.8,'shipments':34,'on_time':'96%','logo':'M'},
    {'name':'MSC','mode':'Ocean','rating':4.6,'shipments':28,'on_time':'93%','logo':'S'},
    {'name':'DHL Express','mode':'Air','rating':4.9,'shipments':22,'on_time':'98%','logo':'D'},
    {'name':'Ethiopian Airlines','mode':'Air','rating':4.5,'shipments':16,'on_time':'91%','logo':'E'},
    {'name':'Hapag-Lloyd','mode':'Ocean','rating':4.7,'shipments':19,'on_time':'94%','logo':'H'},
]

RECENT_ACTIVITY = [
    {'id':1,'type':'status','message':'SHP-001 departed Apapa Port','time':'2h ago'},
    {'id':2,'type':'quote','message':'New quote request from BUA Group','time':'4h ago'},
    {'id':3,'type':'delivered','message':'SHP-003 delivered to London Heathrow','time':'6h ago'},
    {'id':4,'type':'alert','message':'SHP-005 customs clearance delayed','time':'8h ago'},
    {'id':5,'type':'customer','message':'Aliko Holdings placed new booking','time':'1d ago'},
]
